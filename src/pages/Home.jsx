...
const Home = () => {
  ...
  React.useEffect(() => {
    async function fetchData() {
      try {
        const res = await axios.get(`https://hustle-kenya-7azi.onrender.com/products`);
  ...
  React.useEffect(() => {
    async function fetchData() {
      try {
        const res = await axios.get(`https://hustle-kenya-7azi.onrender.com/users`);
        res.data.sort(compare);
                ...
                <Card variant="outlined" sx={{ width: 260 }}>
                  ...
                  <div style={{ display: "flex" }}>
                    <CardContent>
                      ...
                      <Typography className='home-line' level="body2" sx={{ mt: 0.5 }}>
                        ksh {i.price}
